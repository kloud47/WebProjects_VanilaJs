...
////////////////////////////////////////////////////////////////////////////////////////////
/// function for display of movements:
...
/// fuction for creatiing a username:
...
//// Implementing the Login nav bar:
let currentAccount;

btnLogin.addEventListener('click', function(e) {
  e.preventDefault();// prevent form from suubmitting:
...
btnTransfer.addEventListener('click', function(e) {
  ...
  if( amount > 0 && currentAccount.balance >= amount && 
    receiverAcc?.value !== currentAccount.username && receiverAcc ) {
